...
function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center">
      ...
      <p className="mt-4 text-gray-600 text-lg">Explore campus features from the sidebar</p>
      ...
      <div className="mt-10 grid grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-gray-500 mt-2">Emergency assistance when needed.</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-500 mt-2">Find and manage room allocations.</p>
        </motion.div>
      </div>
    </div>
  );
